...
set FAILED=0
for %%T in (test_core test_sweep smoke_v07 check_startup_log check_autotune_dialog check_motor_tab check_sweep_viz check_map_anchor check_task_dispatch check_extras_v099) do (
  echo === %%T ===
